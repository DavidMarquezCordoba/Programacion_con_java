...
public class T04Ejercicio16 {
  public static void main(String[] args) {
    ...
    System.out.println("");
    System.out.print("1. Tu pareja parece estar más inquieta de lo normal sin ningún "+
                      "motivo aparente (true/false): ");
    ...
    System.out.print("4. Ahora se afeita y se asea con más frecuencia (si es hombre) o ahora"+
                    " se arregla el pelo y se asea con más frecuencia (si es mujer) (true/false):  ");
    ...
    System.out.print("6. A veces tiene llamadas que dice no querer contestar cuando estás tú "+
                      "delante (true/false):  ");
    respuesta6 = teclado.nextBoolean();
    System.out.print("7. Últimamente se preocupa más en cuidar la línea y/o estar "+
                      "bronceado/a (true/false):  ");
    respuesta7 = teclado.nextBoolean();
    System.out.print("8. Muchos días viene tarde después de trabajar porque dice tener mucho "+
                      "más trabajo (true/false):  ");
    ...
    System.out.print("10. Se confunde y te dice que ha estado en sitios donde no "+
                      "ha ido contigo (true/false):  ");
